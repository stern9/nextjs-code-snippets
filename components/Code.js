...
export default function Code({ code }) {
  ...
  return (
    <div>
      <button
        className="bg-green-600 text-xs hover:bg-green-900 text-white font-bold py-1 px-2 rounded focus:outline-none focus:shadow-outline mb-2"
        type="submit"
      ...
      {showCode && (
        <div className="relative break-all">
          <pre className="text-gray-800 bg-gray-300 rounded-md p-4">{code}</pre>
